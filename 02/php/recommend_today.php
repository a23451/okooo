...
echo '<form method="post" action="index.php" class="form-horizontal">
    ...
    <div class="control-group"><label class="control-label">场次</label><div class="controls">
        <input class="input-xlarge" type="text" id="date" name="match_no_before" value="001">
    </div></div>
    <div class="control-group"><label class="control-label">主客队名</label><div class="controls">
        <input class="input-xlarge" type="text" id="date" name="match_name_before" value="001">
    </div></div>
...
<script type="text/javascript">
    ...
    dateObj.onchange=function(argument) {
        ...
        selectObj.innerHTML = "";
        $.get("index.php?a=someday_match_data", { date: date.value },
                function(data){
